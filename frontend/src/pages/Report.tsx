...
export default function Report() {
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "background.default", pb: 6 }}>
      ...
      >
        <Box sx={{ maxWidth: 1000, mx: "auto", px: { xs: 2, md: 3 }, py: 1.5, display: "flex", alignItems: "center" }}>
          <Button
        ...
        <Box sx={{ maxWidth: 1000, mx: "auto", px: { xs: 2, md: 3 }, mt: 3 }}>
          ...
          {(report.optimized_title || report.optimized_content || report.cover_direction) && (
            <Box sx={{ ...cardStyle, mb: 2.5 }}>
              <Typography sx={{ fontWeight: 600, fontSize: "0.9375rem", color: "text.primary", mb: 2.5, letterSpacing: "-0.005em" }}>
                AI 优化方案
              </Typography>
